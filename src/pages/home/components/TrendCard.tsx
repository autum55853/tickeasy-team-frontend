  ...
  return (
    <>
      ...
      <div className="flex justify-center lg:hidden">
        <div className="relative mx-4 flex max-w-[90%] flex-col overflow-hidden rounded-lg border-1 border-neutral-200">
          <img src={data.image} alt={data.title} className="max-h-[200px] w-full object-cover" />
      ...
      {/* 電腦板 */}
      <div className="container mx-auto hidden w-[80%] px-4 lg:block">
        <div className="flex">
          <div className="h-fit w-[40%] overflow-hidden rounded-2xl">
          ...
          <div className="flex flex-1 flex-col gap-y-8 p-8">
            ...
            <Button onClick={() => navigate(`/concert/${data.link}`)} variant={"outline"} className="w-[200px] rounded-full px-3 pl-10 text-left">
              <div className="flex w-full items-center justify-between">
