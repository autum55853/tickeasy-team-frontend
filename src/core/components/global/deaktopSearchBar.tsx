...
export default function DesktopSearchBar({
  ...
  return (
    <div
      className={`fixed top-20 left-1/2 z-10 h-[128px] w-full max-w-[1075px] -translate-x-1/2 transform rounded-[24px] bg-white p-6 shadow-sm transition-opacity ${desktopSearchBlock ? "opacity-100" : "opacity-0"} sm:block`}
    >
