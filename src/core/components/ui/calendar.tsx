// refer: https://date-picker.luca-felix.com/
"use client";
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        CaptionLabel: (props) => (
          <CaptionLabel showYearSwitcher={showYearSwitcher} navView={navView} setNavView={setNavView} displayYears={displayYears} {...props} />
        ),
